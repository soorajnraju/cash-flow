...
function App() {
  ...
  const handleInputChange = (index, field, value) => {
    ...
    const parsedValue = field === "comments" ? value : parseFloat(value);
    if (!isNaN(parsedValue) || field === "comments" || value === "") {
      newMonths[index][field] = value === "" ? 0 : parsedValue;
      setMonths(newMonths);
    }
  };
  ...
  const handleFixedIncomeChange = (value) => {
    ...
    if (!isNaN(parsedValue) || value === "") {
      setFixedIncome(value === "" ? 0 : parsedValue);
    }
  };
  ...
  const handleFixedExpensesChange = (value) => {
    const parsedValue = parseFloat(value);
    if (!isNaN(parsedValue) || value === "") {
      setFixedExpenses(value === "" ? 0 : parsedValue);
    }
  };
  ...
  return (
    <div className="App container">
      ...
      <footer className="text-center my-4">Generated by GitHub Copilot</footer>
    </div>
  );
}
